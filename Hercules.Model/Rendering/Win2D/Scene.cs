...
namespace Hercules.Model.Rendering.Win2D
{
    public sealed class Scene : DisposableObject, IRenderScene
    {
        ...
        internal Scene(Document document, Win2DRenderNode previewNode, Func<NodeBase, Win2DRenderNode> nodeFactory)
        {
        ...
        public void Render(CanvasDrawingSession session, RenderFlags renderFlags, Rect2 viewRect)
        {
