...
namespace RavenMind.Model
{
    ...
    public sealed class Layout : ILayout
    {
        ...
        {
            NodeData data = (NodeData)root.Tag;
        ...
        private Size UpdateSizeWithChildren(Size sizeWithChildren, NodeCollection children)
        {
            if (children.Count > 0)
            {
        ...
        private void ArrangeNodes(NodeCollection children, Rect parentRect, Size parentSizeWithChildren, bool isLeft)
        {
            ...
            foreach (Node child in children)
            {
                NodeData data = (NodeData)child.Tag;
