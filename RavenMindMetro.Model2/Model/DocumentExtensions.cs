    ...
    public static class DocumentExtensions
    {
        ...
        public static NodeBase SelectedTopOfSelectedNode(this Document document)
        {
            ...
            if (!document.TrySelectRoot(ref result))
            {
                ...
                if (normalNode != null)
                {
                    ReadOnlyCollection<Node> parentCollection = normalNode.RetrieveParentCollection();
                    ...
                    else
                    {
                        ...
                        {
                            ReadOnlyCollection<Node> grandParentCollection = normalParent.RetrieveParentCollection();
