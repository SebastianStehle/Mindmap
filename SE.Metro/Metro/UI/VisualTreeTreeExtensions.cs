...
namespace SE.Metro.UI
{
    ...
    public static class VisualTreeExtensions
    {
        ...
        /// <param name="args">The <see cref="InputPaneVisibilityEventArgs" /> instance containing the event data. Cannot be null.</param>
        ...
        /// </exception>
        public static bool BringChildElementIntoView(this ScrollViewer scrollViewer, InputPaneVisibilityEventArgs args)
        {
            if (scrollViewer == null)
            {
                throw new ArgumentNullException("scrollViewer");
            ...
            {
                double occludedHeight = args.OccludedRect.Height + 88;
            ...
            return args.EnsuredFocusedElementInView;
        }
        ...
        /// <summary>
        /// Centers the of the y-Coordinate of the target rect.
        /// </summary>
